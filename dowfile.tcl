...
#  Jan 30, 2021 08:56:18 PM EET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 574x148+369+103
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    entry $top.ent46 \
        ...
        -selectforeground white -validate focus -width 514 
    ...
    button $top.but45 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {Сохранить файл} 
    vTcl:DefineAlias "$top.but45" "Button2" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab45 \
        -in $top -x 0 -relx 0.314 -y 0 -rely 0.068 -width 0 -relwidth 0.39 \
        -height 0 -relheight 0.142 -anchor nw -bordermode ignore 
    place $top.ent46 \
        -in $top -x 0 -relx 0.052 -y 0 -rely 0.27 -width 514 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 0 -relx 0.418 -y 0 -rely 0.743 -width 97 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent45 \
        -in $top -x 0 -relx 0.052 -y 0 -rely 0.473 -width 354 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 0 -relx -0.714 -y 0 -rely 0.676 -width 0 -relwidth 0.233 \
        -height 0 -relheight 0.142 -anchor nw -bordermode ignore 
    place $top.but45 \
        -in $top -x 0 -relx 0.767 -y 0 -rely 0.473 -width 107 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
